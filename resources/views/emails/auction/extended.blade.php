            ...
            <tr>
                <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                    ...
                    <p style="margin: 10px 0; text-align:center; font-size:14px;">
                        Auction Extended: {{$auction->end_date}}
                    </p>
                </td>
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                            ...
                            <tr>
                                <td style="font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555; padding-top: 10px;"
                                    ...
                                    <h4 style="margin:0 auto 15px;">This auction ends on {{$auction->end_date}}</h4>
                                    <a class="button-a button-a-primary" href="{{$product->product_url}}"
                                       style="font-family: sans-serif; font-size: 15px; line-height: 15px; text-align:center; text-decoration: none; padding: 13px 17px; display: block;">Place Bid</a>
                                </td>
                            </tr>
                        </table>
                    </td>
